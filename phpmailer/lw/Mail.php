...
if (isset($_POST['txtdest']))
{
	...
	$headers .= "From: site@ajung.com.br".$quebra; //E-mail do remetente
	$headers .= "Return-Path: site@ajung.com.br ".$quebra; //E-mail do remetente
	mail($destino, $assunto, $mensagem, $headers, "-r". "site@ajung.com.br");
